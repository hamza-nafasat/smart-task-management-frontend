...
const Modal = ({ title = "Create New Task", children, onClose }) => {
  return (
    <div
      ...
      onClick={onClose}
    >
      <div className="py-6 px-4 xl:px-6 xl:py-7 bg-[#eef2f5] rounded-[10px] w-[300px] sm:w-[400px] md:w-[500px] lg:w-[900px] xl:w-[1100px] h-[95%] overflow-y-scroll scrollbar-0 overflow-x-hidden" onClick={(e) => e.stopPropagation()}>
